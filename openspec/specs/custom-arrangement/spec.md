...
In custom arrangement mode, the user SHALL be able to drag any flower by clicking and dragging its center point. The flower SHALL follow the pointer continuously during drag and settle at the drop position.
...
#### Scenario: Drop sets new position
- **WHEN** the user releases the drag
- **THEN** the flower SHALL remain at the drop coordinates
